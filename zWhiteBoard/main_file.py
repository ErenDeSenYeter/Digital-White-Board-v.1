...
def addLine(work):
    ...
    canvas.create_line((current_x,current_y,work.x,work.y),width=get_current_value(),fill=color,capstyle=ROUND,smooth=True)#widght changes pencils thichnes
...
#This added to left side a white bar 
...
#This added the bar an additional space for to put color on to it
